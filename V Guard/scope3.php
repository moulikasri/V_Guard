...
<body>
    ...
    <div class="main">
        ...
        <span class="heading">SCOPE 3</span>
        <div class="menu">
            <ul>
        ...
        <div class="main1">
        <?php
            echo '<p style="margin-top: 20px"><a href="unload.php">Unloading per month</a></p>';
        ?>
        </div>
        <div class="main2">
        <?php
            echo '<p style="margin-top: 20px"><a href="load.php">Loading per month</a></p>';
        ?>
        </div>
        <div class="main2">
        <?php
            echo '<p style="margin-top: 20px"><a href="vehicle.php">Other Vehicle</a></p>';
        ?>
        </div>
        <div class="main2">
        <?php
            echo '<p style="margin-top: 20px"><a href="car.php">Car</a></p>';
        ?>
        </div><div class="main2">
        <?php
            echo '<p style="margin-top: 20px"><a href="bike.php">Petrol Bike</a></p><br><br><br><br><br>';
        ?>
    </div>
</body>
</html>