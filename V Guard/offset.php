...
<body>
    ...
    <div class="main">
        ...
        <span class="heading">CO<sub>2</sub> Offset</span>
        <div class="menu">
            <ul><li>
        ...
        <div class="main1">
        <?php
            echo '<p style="margin-top: 20px"><a href="solar.php">Solar PV System</a></p>';
        ?>
        </div>
        <div class="main2">
        <?php
            echo '<p style="margin-top: 20px"><a href="saving.php">Other Energy saving Activity</a></p>';
        ?>
        </div>
