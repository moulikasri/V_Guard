...
<body>
    ...
    <div class="main">
        ...
        <span class="heading">SCOPE 1</span>
        <div class="menu">
            <ul>
        ...
        <div class="main1">
        <?php
            echo '<p style="margin-top: 20px"><a href="380.php">DG - 380 KVA - C0<sub>2</sub> Emission</a></p>';
        ?>
        </div>
        <div class="main2">
        <?php
            echo '<p style="margin-top: 20px"><a href="15.php">DG - 15 KVA - C0<sub>2</sub> Emission</a></p>';
        ?>
        </div>
        <div class="main2">
        <?php
            echo '<p style="margin-top: 20px"><a href="comsumption.php">Company Diesel Consumption</a></p>';
        ?>
        </div>
    </div>
</body>
