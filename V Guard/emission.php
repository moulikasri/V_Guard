...
<body>
    ...
    <div class="main">
        ...
        <span class="heading">CO<sub>2</sub> Emission</span>
        <div class="menu">
            <ul><li>
            <a href="index.php"><span class="fa fa-sign-out">Logout</span></a></li></ul>
        </div>
    </div>
        ...
        <div class="main1">
        <?php
            echo '<p style="margin-top: 20px"><a href="scope1.php">SCOPE 1</a></p>';
        ?>
        </div>
        <div class="main2">
        <?php
            echo '<p style="margin-top: 20px"><a href="scope2.php">SCOPE 2</a></p>';
        ?>
        </div>
        <div class="main2">
        <?php
            echo '<p style="margin-top: 20px"><a href="scope3.php">SCOPE 3</a></p>';
        ?>
        </div>
    </div>
</body>
